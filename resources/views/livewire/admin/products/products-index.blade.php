<div>
    ...
    <div class="sm:flex sm:items-center">
        <div class="sm:flex-auto">
            ...
            <p class="mt-2 text-sm text-gray-700">Liste de tous les produits de votre boutique</p>
        </div>
    ...
    <div class="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-4">
        ...
        <!-- Category Filter -->
        <div>
            <label for="categoryFilter" class="sr-only">Catégorie</label>
    ...
    <!-- Products Grid/Table Toggle could go here -->
                            ...
                            @forelse($products as $product)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="h-12 w-12 bg-gray-200 rounded-lg overflow-hidden flex items-center justify-center">
                                            @if($product->images && count($product->images) > 0)
                                                <img src="{{ $product->images[0]['url'] ?? '/storage/' . $product->images[0]['path'] }}" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div>
                                            ...
                                            @if($product->reference)
                                                <div class="text-sm text-gray-500">Réf: {{ $product->reference }}</div>
                                            @endif
                                        </div>
                                    </td>
